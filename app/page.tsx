...
const brands = [
  ...
  },
  {
    ...
    href: "https://rol-ex.com.pl/upload/Katalog-2026-ENG-LQ.pdf",
    image: "/brands/rol-ex-360/1.jpg",
    imageAlt: "Déchaumeur ROL-EX APG 300",
    bg: "bg-[#14201a]",
    fg: "text-white",
    accent: "#8fae3a",
    reverse: true,
    visualBg: "bg-white",
    spin360: { base: "/brands/rol-ex-360/", count: 36, ext: ".jpg" },
    logo: {
      src: "/brands/rol-ex-logo-carre.png",
      width: 1500,
      height: 1500,
  ...
  },
  {
    ...
    description:
      "Nettoyeurs haute pression à eau froide ou chaude, générateurs de vapeur et systèmes de lavage pour les professionnels de l'entretien et de l'industrie.",
    href: "https://www.dibo.com/fr-be",
    image: "/brands/dibo-logo.png",
    imageAlt: "Nettoyeur haute pression DiBO",
    bg: "bg-[#5f6062]",
    fg: "text-white",
    accent: "#da1f20",
    visualBg: "bg-white",
